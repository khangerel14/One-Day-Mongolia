...
export const Collaborates = () => {
  return (
    <div className='flex items-center bg-[#F2F5FC] py-24 w-full justify-center'>
      <div className='flex justify-between items-center container max-md:flex-col'>
        <div className='flex w-[704px] h-[456px] justify-between gap-5'>
          <div className='flex flex-col items-start gap-8 bottom-8'>
            <div className='bg-white border rounded-lg px-6 py-9 max-md:px-3'>
              <Erdenet />
            </div>
            <div className='bg-white border rounded-lg px-6 py-9 max-md:px-3'>
              <Evseg />
        ...
        <div className='flex flex-col gap-4 w-1/2 pl-32 pr-20 text-black max-md:w-fit'>
